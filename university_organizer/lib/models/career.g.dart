...
Career _$CareerFromJson(Map<String, dynamic> json) => Career(
  ...
  gradeScale: $enumDecodeNullable(_$GradeScaleEnumMap, json['grade_scale']),
  minPassingGrade: (json['min_passing_grade'] as num?)?.toDouble(),
  ...
  status: $enumDecodeNullable(
    _$CareerStatusEnumMap,
    json['status'],
    unknownValue: CareerStatus.active,
  ),
